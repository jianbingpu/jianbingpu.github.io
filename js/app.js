...
function(e, t, i) {
	var n = [function() {
		...
		return t("p", {
			...
			[t("span", [this._v("长按图片保存到手机")]), this._v(" "), t("span", [this._v("更多功能，请关微信公众号:煎饼铺")]), this._v(" "), t("a", {
			attrs: {
